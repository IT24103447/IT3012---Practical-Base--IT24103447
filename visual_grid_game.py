...
# IT24103447 - Lab03 - Step 1.5 - imported SearchAgent for visual search simulation
...
class VisualGridHuntGame:
    ...
    def get_percept(self) -> dict:
        ...
        return {
            ...
            # IT24103447 - Lab03 - Step 1.1 - added global grid information for search
...
class GridGameGUI:
    ...
    def run_loop(self):
        ...
        # IT24103447 - Lab04 - Step 1.3 - created SearchAgent for A* visual simulation
        agent = SearchAgent()
